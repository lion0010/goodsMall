    ...
    <div class="navbar">
      ...
      <div class="navbar-right-container" style="display: flex;">
        <div class="navbar-menu-container">
          ...
          <a href="javascript:void(0)" class="navbar-link" @click="registerModalFlag=true" v-if="!nickName">请注册</a>
          <a href="javascript:void(0)" class="navbar-link" @click="loginModalFlag=true" v-if="!nickName">请登录</a>
